  ...
  hero: [
    {
      ...
      modalBody:
        'Одеса, Чорноморськ, Південний, Констанца, Гданськ. Працюємо напряму з терміналами: внутріпортове експедирування, суднова документація, ПРР, стафінг і анстафінг контейнерів.',
      calcCargoIndex: 0,
  ...
  services: [
    {
      ...
      modalList: [
        'Суднова документація та виписка ордерів за 1 робочий день',
        'Організація ПРР: крани, стивідори, робота терміналу 24/7',
        'Стафінг/анстафінг FCL та LCL контейнерів',
  ...
  contacts: [
    {
      ...
      modalBody: 'Консультація провідних логістів у будь-який час: +38 093 003-85-05.',
      linkLabel: 'Зателефонувати ➔',
      linkHref: 'tel:+380930038505',
    },
    {
      id: 'telegram',
      icon: Send,
  ...
  contacts: [
    {
      ...
      modalEyebrow: 'Hotline',
      modalBody: 'Round-the-clock logistics manager support: +38 093 003-85-05.',
      linkLabel: 'Call now ➔',
      linkHref: 'tel:+380930038505',
    },
    {
